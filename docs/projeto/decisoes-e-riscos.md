...
| --- | --- | --- | --- | --- | --- |
| Cancelamentos de última hora | Média | Alto | Frustração, perda de tempo e queda de confiança na carona combinada | Aplicar regras de cancelamento e atualização clara de status da carona/solicitação | RF13, RNF04, H7 |
