...
const EU = {
  ...
  veiculo: { modelo: "VW Gol", cor: "Branco", placa: "JKP1D45" },
};
...
const MOTORISTAS = {
  m1: {
    ...
    veiculo: { modelo: "Chevrolet Onix", cor: "Prata", placa: "JKL2A•4" },
    avaliacoes: [
  ...
  m2: {
    ...
    veiculo: { modelo: "Hyundai HB20", cor: "Branco", placa: "QRS7H•1" },
    avaliacoes: [
  ...
  m3: {
    ...
    veiculo: { modelo: "Honda Civic", cor: "Preto", placa: "BCD4F•9" },
    avaliacoes: [
  ...
  m4: {
    ...
    veiculo: { modelo: "Jeep Renegade", cor: "Cinza", placa: "MNO9K•2" },
    avaliacoes: [
  ...
  m5: {
    ...
    veiculo: { modelo: "Renault Kwid", cor: "Vermelho", placa: "DEF3G•7" },
    avaliacoes: [
